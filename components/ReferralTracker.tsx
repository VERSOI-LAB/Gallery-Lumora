...
// Logs where a visit came from (YouTube/Instagram/Facebook) so /admin/traffic
// can show inbound traffic sources. Runs once per full page load — mounted
// in the root layout, which only remounts on a hard navigation.
