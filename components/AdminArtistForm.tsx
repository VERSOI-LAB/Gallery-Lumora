...
export default function AdminArtistForm({ artist }: { artist?: Artist }) {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    const input: ArtistInput = {
      ...
      businessRegCertUrl: artist?.businessRegCertUrl ?? "",
      businessOwnerName: artist?.businessOwnerName ?? "",
      businessAddress: artist?.businessAddress ?? "",
      businessPhone: artist?.businessPhone ?? "",
      commissionAccepting,
      commissionMedia,
      commissionLeadTime,
