...
/** Spotlights up to 10 artworks — admin-picked via "전시 메인으로 설정" in
 * 작품 관리, or the most recent artworks when none is picked yet. Always
 * shows each artwork's own photo, never a separate background image. */
